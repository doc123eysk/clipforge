  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-12">
      <div className="mb-12 text-center">
        <h1 className="animate-slide-up mb-4 text-5xl font-bold">
          <span className="gradient-text">Нарежьте видео</span>
        </h1>
        <p className="animate-slide-up delay-100 text-lg text-zinc-500">Загрузите видео, выделите клипы на таймлайне, скачайте shorts</p>
      </div>
      ...
      {videos.length > 0 && (
        <div>
          <h2 className="mb-6 text-xl font-semibold text-zinc-200">Ваши видео</h2>
          <div className="grid gap-4 md:grid-cols-2">
            {videos.map((v) => (
              <a key={v.id} href={`/videos/${v.id}`} className="glass card-glow flex items-center gap-4 rounded-2xl p-4 transition hover:bg-white/[0.04]">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#818cf8" strokeWidth="2"><polygon points="23 7 16 12 23 17 23 7" /><rect x="1" y="5" width="15" height="14" rx="2" ry="2" /></svg>
                </div>
